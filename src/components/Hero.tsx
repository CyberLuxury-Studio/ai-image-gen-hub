...
export default function Hero() {
  return (
    <section className="pt-40 pb-20 px-6 text-center relative overflow-hidden min-h-[90vh] flex flex-col justify-center">
      ...
      >
        THE ai image gen hub <br/><span className="text-[#00FF41] underline decoration-[#FF003C] underline-offset-8">PROTOCOL.</span>
      </motion.h1>
      ...
      >
        Build an AI image generator dashboard showcase. Engineered for extreme data density and uncompromising security.
      </motion.p>
